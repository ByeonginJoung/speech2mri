...
do
    ...
    python train.py --dataset mri --exp_name $EXP_NAME --sub_name $SUB_N --config_name $CONF_NAME --dataset_type '75-speaker-word'
    
    #CONF_NAME=mri_melspectogram_baseline_ver0004_multi
    #EXP_NAME=lstm_msessim_256_$CONF_NAME
    #python train.py --dataset mri --exp_name $EXP_NAME --sub_name $SUB_N --config_name $CONF_NAME --dataset_type '75-speaker-multi'
    
    CONF_NAME=mri_melspectogram_baseline_ver0004_multi_word
    EXP_NAME=lstm_msessim_256_$CONF_NAME

    python train.py --dataset mri --exp_name $EXP_NAME --sub_name $SUB_N --config_name $CONF_NAME --dataset_type '75-speaker-multi-word'
done
