...
def get_args():
    args_edict = edict()
    args_edict.dataset_dir = '/hdd4tb_00/dataset/usc_timit/USC-TIMIT/MRI/Data'
    
    args_edict.seed = 1234

    args_edict.train_epoch = 2000
    args_edict.epoch_print = 50
    ...
    args_edict.data.frameShift = 1902
    args_edict.data.fps_control_ratio = 1. # strongly recommended usage for this value as int type
